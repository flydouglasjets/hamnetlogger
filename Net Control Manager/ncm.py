...
class NetControlApp(QMainWindow):
    ...
    def setup_shortcuts(self):
        ...
        self.shortcut_traffic_edit = QShortcut(QKeySequence("Ctrl+E"), self)
    ...
    def init_ui(self):
        ...
        # Restructured Status Widget (Stacked label over combo box)
        ...
        legend_label = QLabel("[F2] Add Station  |  [F3] Search Roster  |  [Ctrl+T] Toggle Standby  |  [Ctrl+U] Check Out  |  [Del] Delete Station")
        legend_label.setStyleSheet("color: #000080;")
        ...
        station_layout.addWidget(self.legend_frame)
        ...
        activity_legend_label = QLabel("[F5] Search Traffic  |  [Ctrl+E] Edit Details  |  [Ctrl+Del] Delete Entry")
        ...
        self.btn_export_csv.setFixedSize(65, 36)
        self.btn_export_csv.clicked.connect(self.export_csv)

        self.btn_export_pdf = QPushButton("Export\nPDF")
        self.btn_export_pdf.setFixedSize(65, 36)
        self.btn_export_pdf.clicked.connect(self.export_pdf)

        self.btn_reset = QPushButton("Reset\nNet")
        self.btn_reset.setFixedSize(65, 36)
        self.btn_reset.setStyleSheet(BTN_RESTORE_STYLE)
        self.btn_reset.clicked.connect(self.reset_entire_net)

        self.btn_exit = QPushButton("Exit")
        self.btn_exit.setFixedSize(65, 36)
    ...
    def restore_session(self):
        ...
        try:
            ...
            time_rem = data.get("time_remaining", 10)
