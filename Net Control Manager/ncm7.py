    ...
    def __init__(self, parent=None):
        ...
        sections = [
            ...
            ("Roster Management", [
                ...
                ("F3", "Search Roster by Callsign Substring"),
            ...
            ("Log, Web API & NCS", [
                ("F5", "Search Activity Log by Callsign Substring"),
...
class StationSearchDialog(QDialog):
    def __init__(self, parent=None):
        ...
        layout = QVBoxLayout(self)
        lbl = QLabel("Enter Callsign / Substring to Search:")
        lbl.setFont(QFont("Tahoma", 9, QFont.Weight.Bold))
        layout.addWidget(lbl)

        self.input_search = UppercaseLineEdit()
        self.input_search.setPlaceholderText("e.g., W9A or 9A")
...
class NetControlApp(QMainWindow):
    ...
    def open_search_dialog(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            if not found:
                QMessageBox.information(self, "Search Result", f"Callsign substring '{term}' not found in roster.")
